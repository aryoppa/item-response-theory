...
# rules[['antecedents', 'consequents']].to_csv("./data/apriori/association_rules.csv", index=False)
# Convert frozensets or sets in the specific columns to strings
...
print(rules[['antecedents', 'consequents', 'combined']])
